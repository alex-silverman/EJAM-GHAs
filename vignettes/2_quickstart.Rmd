...
![Summary table of Summary Indexes, population subgroups, sex, and language indicators](images/image-report_EJ_table_example.png){width="100%"} ![US map showing analyzed points](images/image-map_example.png){width="100%"}
