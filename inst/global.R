...
# This "global.R" file defines most 
...
#
# The complementary file "manage-public-private.R" defines many other options and defaults --
#  see that file for more information about the public (general public) vs. private (specialized) distinction.

# Note: Do not set defaults specific to a shiny module UNTIL INSIDE THE MODULE.
#   e.g., The EJAM ejscreenapi module uses its own global.R file:
...
# "default_show_full_header_footer"    "stepradius"    "use_shapefile_from_any"    
######################################################## #

######################################################################################################## #

# title of app is defined in manage-public-private.R
...
html_header_fmt <- tagList(
  ...
  ######################################################################## #
  if (!default_show_full_header_footer) {
...
',
                default_titleLogo_html   # DEFINED IN manage-public-private.R (as either EPA logo or EJAM logo) 
,'
