...
tnames <- c(
  "testinput_address_parts1", 
  "testinput_addresses2",
  
  "testinput_address_table9",
  "testinput_addresses_9", 
...
testinput_address_parts1 <- c("latitude", "LONGITUDE",
                         "address", "STREET", "City", "Statename", "zipcode")

testinput_addresses2 <- c("1200 Pennsylvania Ave, NW Washington DC",
                     "Research Triangle Park")


testinput_address_table9 <- structure(list(
...
testinput_addresses_9 <- address_from_table(testinput_address_table9)
...
testinput_address_table_withfull <- data.frame(Address = testinput_addresses2, testinput_address_table)
...
# testinput_address_parts1          = metadata_add(testinput_address_parts1)
# testinput_addresses2              = metadata_add(testinput_addresses2)
# 
# testinput_address_table9         = metadata_add(testinput_address_table9)
# testinput_addresses_9             = metadata_add(testinput_addresses_9)
# 
# testinput_address_table           = metadata_add(testinput_address_table)
# testinput_address_table_goodnames = metadata_add(testinput_address_table_goodnames)
# testinput_address_table_withfull  = metadata_add(testinput_address_table_withfull)
...
savex(testinput_address_table9,         "./inst/testdata/address", "testinput_address_table9.xlsx")
