...
# Then, this script below was to add columns to usastats and statestats with info on residential population subgroups
...
setdiff_yx(names(  usastats), c(names_e, names_d, names_ej  ,     names_ej_supp      ))
setdiff_yx(names(statestats), c(names_e, names_d, names_ej_state, names_ej_supp_state))
#
# 
...
setdiff_yx(names(statestats), c(EJAM::names_e, EJAM::names_d, EJAM::names_ej_state, EJAM::names_ej_supp_state  ))
setdiff_yx(names(  usastats), c(EJAM::names_e, EJAM::names_d, EJAM::names_ej  ,     EJAM::names_ej_supp      ))
############################################################################# # 
