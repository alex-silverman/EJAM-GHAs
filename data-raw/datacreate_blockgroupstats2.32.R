...
fnames <- c(
  ...
  blockgroupstats_source_state.zip, # we need this only for its state versions of summary indexes (used to create state pctiles)
  usastats_source.csv,
...
arrow::write_ipc_file(bg_islandareas, sink = file.path(localfolder, "bg_islandareas.arrow"))
