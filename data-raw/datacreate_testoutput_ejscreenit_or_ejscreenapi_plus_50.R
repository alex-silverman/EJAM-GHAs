...
if (make_testoutput_ejscreenRESTbroker_1pts_1miles) {
  ...
  testoutput_ejscreenRESTbroker_1pts_1miles <- metadata_add(testoutput_ejscreenRESTbroker_1pts_1miles)
...
if (make_testoutput_ejscreenapi_1pts_1miles) {
  ...
  testoutput_ejscreenapi_1pts_1miles <- metadata_add(testoutput_ejscreenapi_1pts_1miles)
...
if (make_testoutput_ejscreenapi_plus_5) { 
  ...
  testoutput_ejscreenapi_plus_5 <- metadata_add(testoutput_ejscreenapi_plus_5)
...
if (make_testoutput_ejscreenapi_plus_50) {
  ...
  testoutput_ejscreenapi_plus_50  <- metadata_add(testoutput_ejscreenapi_plus_50)
...
if (make_testoutput_ejscreenapi_plus_500) {
  ...
  testoutput_ejscreenapi_plus_500 <- metadata_add(testoutput_ejscreenapi_plus_500)
...
if (make_testoutput_ejscreenit_5) {
  ...
  testoutput_ejscreenit_5 <- metadata_add(testoutput_ejscreenit_5)
...
if (make_testoutput_ejscreenit_50) {
  ...
  testoutput_ejscreenit_50 <- metadata_add(testoutput_ejscreenit_50)
...
if (make_testoutput_ejscreenit_500) {
  ...
  testoutput_ejscreenit_500 <- metadata_add(testoutput_ejscreenit_500)
