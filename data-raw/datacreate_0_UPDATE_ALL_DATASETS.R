...
if (0 == 1) {  # collapsable list
  ...
  x <- c("datacreate_0_UPDATE_ALL_DATASETS.R", "datacreate_0_UPDATE_ALL_DOCUMENTATION_pkgdown.R",
         ...
         "datacreate_usastats2.32.R", "datacreate_usastats2.32_add_dsubgroups.R", "datacreate_avg.in.us.R", "datacreate_high_pctiles_tied_with_min.R", "datacreate_formulas.R", "datacreate_testinput_address_table.R", "datacreate_testpoints_testoutputs.R", 
         ...
         "datacreate_epa_programs_defined.R", "datacreate_testinput_program_sys_id.R", "datacreate_testinput_registry_id.R", "datacreate_naics_counts.R", "datacreate_naicstable.R", "datacreate_SIC.R", "datacreate_sic_counts.R", "datacreate_sictable.R", 
  ...
  documentOpen('./data-raw/datacreate_testinput_address_table.R')       # ok
