      ...
      tabsetPanel( # up to line 1101 or so
        ...
        tabPanel(title = 'About',
                 ...
                 fluidRow(
                   ...
                   column(4,
                          img(id = "biglogo", src = 'www/ejamhex4.png')
                   )
                 )
        ), # end About EJAM tab
        ...
        tabPanel(
          ...
          #h3('Welcome to EJAM'),
          # div(
          #   p("EJScreen's multisite tool (EJAM) lets you explore the residential population data and environmental conditions in any list of places, such as for everyone who lives within 1 mile of a certain type of EPA-regulated site. EJAM stands for the EJ Analysis Multisite tool."),
              ...
              div(style = 'border: 1px solid #005ea2; padding: 10px;',
                  ...
                  conditionalPanel(
                    ...
                    selectInput(inputId = 'ss_choose_method_drop',
                                ...
                                choices = default_choices_for_type_of_site_category
                    )
                  ),
                  ...
                  conditionalPanel(
                    ...
                    selectInput(inputId = 'ss_choose_method_upload',
                                ...
                                choices = default_choices_for_type_of_site_upload
                    )
                  ),
              ),
                          ...
                          conditionalPanel(
                            ...
                            tags$span(
                              tags$ul(
                                ...
                                tags$li(tags$a(href = 'https://github.com/ejanalysis/ejscreendata/blob/master/testdata/registryid/frs_testinput_regid_8.xlsx?raw=true', target = '_blank', 
                                        ...
                                        fluidRow(
                                          column(4,
                                                 ...
                                                 selectInput(inputId = 'demog_high_at_what_share_of_sites',
                                                             label = 'Residential population indicators high at what share of sites?',
