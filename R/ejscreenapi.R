...
ejscreenapi <- function(lon, lat, radius = 3, unit = 'miles', wkid = 4326 ,
  ...
  ### State percentiles Summary index - 2-factor and then supplemental 5-factor versions
  ...
  ### US percentiles Summary index - 2 then 5-factor (suppl)
  ...
  ### 
  ### language, race ethnicity subgroups, other residential population data including counts --------------------------------------- #
