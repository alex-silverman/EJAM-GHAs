...
#' 
#' pts <- latlon_from_address(testinput_addresses_9[1:2])
...
#' }
#' fixcolnames_infer(currentnames = testinput_address_parts1)
...
#'   # #testinput_addresses2b <- c("1200 Pennsylvania Ave, NW Washington DC", "Research Triangle Park")
#'   # #x <- geocode(testinput_addresses2b)
